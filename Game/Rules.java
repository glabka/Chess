...
public class Rules {
	...
	public static boolean move(GameState gs, Player p, Board b, MoveTracker mt, Move mv) {
		return move(gs, p, b, mt, mv.getVerFrom(), mv.getHorFrom(), mv.getVerTo(), mv.getHorTo());
	}
